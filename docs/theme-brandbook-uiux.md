# LUSENA Theme Brandbook Ă˘â‚¬â€ť UI/UX & Implementation Guide

> **Generated:** 2026-02-20 Ă‚Â· **Theme base:** Dawn v15.4.1 Ă‚Â· **Brand:** LUSENA (PL-first, premium silk)
...
1. **Brand rules:** `docs/LUSENA_BrandBook_v1.md` Ă˘â‚¬â€ť colors, tone, photography, personality.
2. **Theme implementation guide:** **This document** Ă˘â‚¬â€ť how brand rules are realized in code.
...
```
lusena-dawn/
Ă˘â€ťĹ›Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬ assets/          # Global CSS (base.css, lusena-shop.css), JS (global.js, cart-drawer.js, etc.)
Ă˘â€ťĹ›Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬ config/          # settings_schema.json (theme editor schema), settings_data.json (current values)
Ă˘â€ťĹ›Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬ layout/          # theme.liquid (main layout), password.liquid
Ă˘â€ťĹ›Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬ locales/         # en.default.json, en.default.schema.json, pl.json, etc.
Ă˘â€ťĹ›Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬ sections/        # lusena-*.liquid (custom), Dawn defaults (main-product, etc.)
Ă˘â€ťĹ›Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬ snippets/        # lusena-*.liquid (custom), Dawn defaults (meta-tags, etc.)
Ă˘â€ťĹ›Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬ templates/       # .json files mapping URLs to section compositions
Ă˘â€ťâ€ťĂ˘â€ťâ‚¬Ă˘â€ťâ‚¬ docs/            # LUSENA_BrandBook_v1.md, THEME_CHANGES.md, this file
```

### 2.2 How the rendering pipeline works

```
layout/theme.liquid                      Ă˘â€ Â HTML shell, <head>, global CSS/JS
  Ă˘â€ťĹ›Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬ sections/header-group.json         Ă˘â€ Â header section group
  Ă˘â€ťâ€š     Ă˘â€ťâ€ťĂ˘â€ťâ‚¬Ă˘â€ťâ‚¬ sections/lusena-header.liquid
  Ă˘â€ťĹ›Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬ {{ content_for_layout }}           Ă˘â€ Â page content injected here
  Ă˘â€ťâ€š     Ă˘â€ťâ€ťĂ˘â€ťâ‚¬Ă˘â€ťâ‚¬ templates/{name}.json        Ă˘â€ Â maps URL to ordered section list
  Ă˘â€ťâ€š           Ă˘â€ťâ€ťĂ˘â€ťâ‚¬Ă˘â€ťâ‚¬ sections/lusena-{X}.liquid
  Ă˘â€ťâ€š                 Ă˘â€ťĹ›Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬ snippets/lusena-{Y}.liquid   Ă˘â€ Â reusable fragments
  Ă˘â€ťâ€š                 Ă˘â€ťâ€ťĂ˘â€ťâ‚¬Ă˘â€ťâ‚¬ {% stylesheet %} / {% javascript %}  Ă˘â€ Â scoped CSS/JS
  Ă˘â€ťĹ›Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬ sections/footer-group.json
  Ă˘â€ťâ€š     Ă˘â€ťâ€ťĂ˘â€ťâ‚¬Ă˘â€ťâ‚¬ sections/lusena-footer.liquid
  Ă˘â€ťâ€ťĂ˘â€ťâ‚¬Ă˘â€ťâ‚¬ snippets/cart-drawer.liquid        Ă˘â€ Â rendered globally when cart_type == 'drawer'
```
...
| Google Fonts | Inter (body), Source Serif 4 (headings) Ă˘â‚¬â€ť loaded via `<link>` |
...
| `lusena_free_shipping_threshold` | `"269"` (zÄąâ€š) | Free shipping progress bar target |
| `lusena_primary_add_to_cart_label` | `"Dodaj do koszyka Ă˘â‚¬â€ś wysyÄąâ€ška w 24 h"` | Primary ATC button text |
...
--accent-cta: #0E5E5A;   /* deep teal Ă˘â‚¬â€ť CTA & accents */
```
...
- **CTA color is always `#0E5E5A`** Ă˘â‚¬â€ť never change it between pages (brandbook rule).
- **Max 1Ă˘â‚¬â€ś2 color accents per screen** Ă˘â‚¬â€ť teal for CTA, optional gold for badges.
- **Backgrounds alternate** between `bg-brand-bg` / `bg-white` / `bg-surface-1` / `bg-surface-2` to visually separate section bands.
- **Status colors** Ă˘â‚¬â€ť green `#2F7D4E` for success/in-stock, red `#B91C1C` for error/out-of-stock.
...
|---|---|---|---|
| `.text-[8px]` | 8px | Ă˘â‚¬â€ť | Minor decorative UI |
| `.text-[10px]` | 10px | Ă˘â‚¬â€ť | Cart count badge |
...
```css
h1, .h1 { font-size: calc(var(--font-heading-scale) * 3rem); }   /* 30px Ă˘â€ â€™ 40px @750px */
h2, .h2 { font-size: calc(var(--font-heading-scale) * 2rem); }   /* 20px Ă˘â€ â€™ 28px @750px */
h3, .h3 { font-size: calc(var(--font-heading-scale) * 1.7rem); }  /* 17px Ă˘â€ â€™ 20px @750px */
```
...
|---|---|---|
| `.tracking-tight` | Ă˘Ââ€™0.025em | Large hero headlines |
...
| `.uppercase` | Ă˘â‚¬â€ť | Kickers, option labels, badge text |
...
**Brandbook rule:** Minimum 1.4Ä‚â€” line-height for text blocks > 3 lines.
...
```
4 Ă˘â€ â€™ 6 Ă˘â€ â€™ 8 Ă˘â€ â€™ 12 Ă˘â€ â€™ 16 Ă˘â€ â€™ 20 Ă˘â€ â€™ 24 Ă˘â€ â€™ 32 Ă˘â€ â€™ 48 Ă˘â€ â€™ 64 Ă˘â€ â€™ 96 Ă˘â€ â€™ 128 px
```
...
Dawn's `.page-width` (from `assets/base.css`): `max-width: var(--page-width)` (1300px), padding `0 1.5rem` Ă˘â€ â€™ `0 5rem` at 750px.
...
- `assets/lusena-spacing.css` (tokens, tier classes, intra-section gap utilities, content-flow utilities) â€” loaded as a standalone `<link>` in `layout/theme.liquid`
...
> **For new sections:** Use the Tailwind breakpoints (`md:`, `lg:`, `xl:`). The `768px` breakpoint is the primary mobileĂ˘â€ â€™desktop switch in LUSENA sections.
...
|---|---|---|
| `rounded-brand` (0.6rem / 6px) | **Brand standard** Ă˘â‚¬â€ť buttons, inputs, cart items | `snippets/lusena-missing-utilities.liquid` |
| `rounded-sm` (0.2rem / 2px) | Subtle rounding Ă˘â‚¬â€ť payment badges, media thumbnails | `assets/lusena-shop.css` |
| `rounded-full` (9999px) | Circles Ă˘â‚¬â€ť icon buttons, color swatches, dots, cart badge | `assets/lusena-shop.css` |
| `0` | Sharp Ă˘â‚¬â€ť media containers, product cards | `config/settings_data.json` |
...
> **Brandbook alignment:** "Shadows sparingly." The theme respects this Ă˘â‚¬â€ť most `shadow_opacity` settings are `0` in `config/settings_data.json`.
...
- Start state: `opacity: 0; transform: translateY(14px)` Ă˘â‚¬â€ť transitions to `opacity: 1; transform: none`
- Stagger: `[data-lusena-stagger]` on container Ă˘â‚¬â€ť children get `--lusena-delay` (70ms per child)
...
Both systems coexist. LUSENA sections use both Ă˘â‚¬â€ť typically Dawn's `scroll-trigger` for block-level reveals and LUSENA's custom system for finer effects.
...
| Hero image entry | scale 1.04Ă˘â€ â€™1 | 900ms | ease-out-slow |
| Hero text entry | translateY + opacity | 650ms | ease-out-slow (120ms/220ms delay) |

**Brandbook alignment:**
- UI hover/focus: 150Ă˘â‚¬â€ś200ms Ă˘Ĺ›â€ś
- Modals/hero: 250Ă˘â‚¬â€ś400ms Ă˘Ĺ›â€ś
- Easing: calm ease-in-out, no springy/bouncy Ă˘Ĺ›â€ś
- `prefers-reduced-motion`: All animations respect it Ă˘Ĺ›â€ś

#### 3.6.4 Hover states (validated)

| Element | Hover effect |
|---|---|
| `.lusena-btn--primary` | `background: rgb(14 94 90 / 0.9)` Ă˘â‚¬â€ť slight fade (Ă˘â€°Â10% lighten) |
| `.lusena-btn--outline` | `background: rgb(14 94 90 / 0.05)` Ă˘â‚¬â€ť teal tint 5% |
| `.lusena-btn--ghost` | `background: rgb(240 238 235)` Ă˘â‚¬â€ť surface-2 fill |
| Icon buttons | Ghost: `bg: #F0EEEB`; Overlay: `opacity Ă˘â€ â€™ 1`; Subtle: `bg: 10% gray` |
...
- CSS transitions Ă˘â€ â€™ `0.15s` or `none`
- CSS animations Ă˘â€ â€™ `none` or reduced to simple opacity fade
...
**File:** `snippets/lusena-button-system.liquid` (global Ă˘â‚¬â€ť loaded on every page via `layout/theme.liquid`)
...
| PDP | `.lusena-btn--size-pdp` | 4.8rem | 4rem | Ă˘â‚¬â€ť |
| LG | `.lusena-btn--size-lg` | 5.6rem | 4rem | 1.6rem |
| Icon | `.lusena-btn--size-icon` | 4.4rem square | 0 | Ă˘â‚¬â€ť |
...
**Full-width modifier:** `.lusena-btn--full-width` Ă˘â€ â€™ `width: 100%`.
...
- **Touch targets:** All buttons meet 44Ä‚â€”44px minimum.
...
**Color swatches:**
- `.lusena-option__swatch` Ă˘â‚¬â€ť 4.4rem circle, `rounded-full`, background from swatch color.
...
**Size/option pills:**
- `.lusena-option__pill` Ă˘â‚¬â€ť Rectangle, `px-6 py-2`, `border border-secondary/30`, `min-w-[6.4rem]`.
- Selected: Highlighted border. Hover: `border-accent-cta`.

**Accessibility:**
- `<fieldset>` + `<legend>` grouping per option.
- Hidden `<input type="radio">` (`.visually-hidden`) Ă˘â€ â€™ native keyboard/screen reader support.
...
<div class="flex items-center border border-secondary/20 rounded-brand">
  <button class="lusena-icon-button lusena-icon-button--subtle lusena-icon-button--sm">Ă˘Ââ€™</button>
...
<a class="lusena-product-card block cursor-pointer">
  <div class="relative aspect-[4/5] bg-surface-2 overflow-hidden mb-4">
    <span class="absolute top-2 left-2 z-10 Ă˘â‚¬Â¦ uppercase">Badge</span>
    <img class="lusena-product-card__image--primary Ă˘â‚¬Â¦" loading="lazy"/>
    <img class="lusena-product-card__image--secondary opacity-0 Ă˘â‚¬Â¦"/>
  </div>
...
- `p-6` to `p-8` padding
- Consistent text hierarchy: small kicker Ă˘â€ â€™ heading Ă˘â€ â€™ body
...
- **Mobile menu:** Native `<details>/<summary>` with animated CSS grid expansion (`0fr Ă˘â€ â€™ 1fr`, 260ms). Panel has `inert` attribute toggled for accessibility.
...
<nav aria-label="Breadcrumb" class="py-4">
  <ol class="flex items-center gap-1.5 text-xs text-neutral-700">
    <li><a href="/">Strona gÄąâ€šÄ‚Ĺ‚wna</a> <chevron-right/></li>
...
```
Ă˘â€ťĹšĂ˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťÂ
Ă˘â€ťâ€š  Breadcrumbs (full width)                                Ă˘â€ťâ€š
Ă˘â€ťĹ›Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťÂ¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťÂ¤
Ă˘â€ťâ€š  Media Gallery       Ă˘â€ťâ€š  Buybox                          Ă˘â€ťâ€š
Ă˘â€ťâ€š  (7 cols)            Ă˘â€ťâ€š  (5 cols)                        Ă˘â€ťâ€š
Ă˘â€ťâ€š  Ă˘â€ťĹšĂ˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťÂ¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťÂ Ă˘â€ťâ€š  Ă˘â€ťĹšĂ˘â€ťâ‚¬ Summary (title, price)      Ă˘â€ťâ€š
Ă˘â€ťâ€š  Ă˘â€ťâ€š ThumbĂ˘â€ťâ€š Main     Ă˘â€ťâ€š Ă˘â€ťâ€š  Ă˘â€ťĹ›Ă˘â€ťâ‚¬ Proof Chips (5 badges)      Ă˘â€ťâ€š
Ă˘â€ťâ€š  Ă˘â€ťâ€š stripĂ˘â€ťâ€š stage    Ă˘â€ťâ€š Ă˘â€ťâ€š  Ă˘â€ťĹ›Ă˘â€ťâ‚¬ Variant Picker               Ă˘â€ťâ€š
Ă˘â€ťâ€š  Ă˘â€ťâ€š      Ă˘â€ťâ€š          Ă˘â€ťâ€š Ă˘â€ťâ€š  Ă˘â€ťĹ›Ă˘â€ťâ‚¬ ATC Button + Buy Now        Ă˘â€ťâ€š
Ă˘â€ťâ€š  Ă˘â€ťâ€š      Ă˘â€ťâ€š (zoom)   Ă˘â€ťâ€š Ă˘â€ťâ€š  Ă˘â€ťĹ›Ă˘â€ťâ‚¬ Guarantee Box               Ă˘â€ťâ€š
Ă˘â€ťâ€š  Ă˘â€ťâ€š      Ă˘â€ťâ€š          Ă˘â€ťâ€š Ă˘â€ťâ€š  Ă˘â€ťĹ›Ă˘â€ťâ‚¬ Payment Badges               Ă˘â€ťâ€š
Ă˘â€ťâ€š  Ă˘â€ťâ€ťĂ˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťÂ´Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťÂ Ă˘â€ťâ€š  Ă˘â€ťĹ›Ă˘â€ťâ‚¬ Buybox Accordion (Specs/Care)Ă˘â€ťâ€š
Ă˘â€ťâ€š                      Ă˘â€ťâ€š  Ă˘â€ťâ€ťĂ˘â€ťâ‚¬ Cross-sell                   Ă˘â€ťâ€š
Ă˘â€ťâ€ťĂ˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťÂ´Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťâ‚¬Ă˘â€ťÂ
```

Mobile: Stacked vertically Ă˘â‚¬â€ť horizontal scroll gallery with dots, then buybox.
...
| `lusena-pdp-scripts` | All PDP JS (inline `{% javascript %}` Ă˘â‚¬â€ť ~1835 lines) |
...
| Zone | Content |
|---|---|
| **Header** | "TwÄ‚Ĺ‚j koszyk" (serif heading) + close button |
| **Empty state** | Shopping bag icon, "TwÄ‚Ĺ‚j koszyk jest pusty", browse CTA, close button |
...
| **Footer** | Subtotal, free shipping progress bar (teal fill Ă˘â€ â€™ green when qualified), checkout CTA (primary, full-width, LG), 60-day return trust line, "Kontynuuj zakupy" link |
...
- Fill color: Teal Ă˘â€ â€™ green (`rgb(47 125 78)`) via `--qualified` modifier when threshold met.
- Width transition: 500ms.
- Threshold: configurable via `lusena_free_shipping_threshold` setting (default: 269 zÄąâ€š).
...
**FAQ accordion:**
- Native `<details>` elements Ă˘â‚¬â€ť accessible by default (keyboard + screen reader).
- JS adds animated height transitions: `height: 0` Ă˘â€ â€™ `scrollHeight` on open, reverse on close.
...
See section 4.4. CSS grid `0fr Ă˘â€ â€™ 1fr` expansion, `inert` toggling.
...
| Everything else | `lazy` | Ă˘â‚¬â€ť | Varies (see below) |
...
| Context | Max size |
|---|---|
| Hero (desktop) | 250Ă˘â‚¬â€ś300 KB (WebP/AVIF) |
| Hero (mobile) | 150Ă˘â‚¬â€ś200 KB |
| PLP card | 120Ă˘â‚¬â€ś160 KB |
| PDP gallery (first 2Ă˘â‚¬â€ś3 frames) | 180Ă˘â‚¬â€ś220 KB each |
...
| **Centered text column** | `lusena-heritage`, `lusena-quality-hero` | Narrow `max-w-2xl`Ă˘â‚¬â€ś`max-w-4xl`, centered, serif heading + body text |
...
```
Ă˘â€ťĹšĂ˘â€ťâ‚¬ Kicker (small uppercase .tracking-wider .text-secondary, optional)
Ă˘â€ťĹ›Ă˘â€ťâ‚¬ Heading (.font-serif, size varies by section importance)
Ă˘â€ťĹ›Ă˘â€ťâ‚¬ Subheading or body (.text-secondary, 1Ă˘â‚¬â€ś3 sentences)
Ă˘â€ťâ€ťĂ˘â€ťâ‚¬ CTA (lusena-btn, optional)
```

#### Background alternation pattern (homepage example)

```
Hero         Ă˘â€ â€™ image background (dark overlay)
Trust bar    Ă˘â€ â€™ bg-brand-bg
Problem/Sol  Ă˘â€ â€™ bg-brand-bg
Bestsellers  Ă˘â€ â€™ bg-surface-1
Heritage     Ă˘â€ â€™ bg-brand-bg
Testimonials Ă˘â€ â€™ bg-surface-1
Bundles      Ă˘â€ â€™ bg-surface-2
FAQ          Ă˘â€ â€™ bg-surface-1
Newsletter   â†' bg-surface-2
```
...
- **Max 70Ă˘â‚¬â€ś80 characters per line** (desktop), **38Ă˘â‚¬â€ś45** (mobile) Ă˘â‚¬â€ť enforced by `max-w-*` constraints.
...
- **Card grids:** 1Ă˘â€ â€™2Ă˘â€ â€™3 or 1Ă˘â€ â€™2Ă˘â€ â€™4 columns depending on card complexity.
...
| Rule | Example |
|---|---|
| Speak plainly about specifics | "22 momme, kontrola jakoÄąâ€şci kaÄąÄ˝dej partii" not "NajwyÄąÄ˝sza jakoÄąâ€şĂ„â€ˇ!" |
| Max 18Ă˘â‚¬â€ś22 words per sentence | Keep short for scanning |
| Fewer adjectives, more proof | Pair claims with data: "precyzyjne szwy Ă˘â‚¬â€ś odstĂ„â„˘p ~3 mm" |
| Calm, don't rush | "WysyÄąâ€šamy w 24 h" not "Kup teraz, bo zniknie!" |
...
|---|---|---|
| PDP primary | "Dodaj do koszyka Ă˘â‚¬â€ś wysyÄąâ€ška w 24 h" | Benefit + operational promise |
| PDP secondary | "Kup teraz i zapÄąâ€šaĂ„â€ˇ" | Direct action |
| Cart checkout | "PrzejdÄąĹź do kasy" | Clear next step |
| Cart upsell | "Dodaj" | Minimal, no pressure |
| Empty cart | "PrzeglĂ„â€¦daj produkty" | Exploratory, not pushy |
...
| Context | Pattern |
|---|---|
| Stock available | "W magazynie Ă˘â‚¬â€ś gotowe do wysyÄąâ€ški" |
| Stock unavailable | "Chwilowo niedostĂ„â„˘pne" |
| Guarantee | "60 Dni Gwarancji Przespanych Nocy" |
| Shipping progress | "Darmowa dostawa za X zÄąâ€š" / "Darmowa dostawa! Ă˘Ĺ›â€ś" |
| Cart upsell success | "Ă˘Ĺ›â€ś Dodano do koszyka" |
| Proof chips | "OEKO-TEXĂ‚Â® 100", "22 momme", "WysyÄąâ€ška 24h z PL", "60 dni na zwrot", "Na prezent" |

### 6.4 PL localization rules (from brandbook)

| Rule | Format |
|---|---|
| Currency | "1 249,00 zÄąâ€š" (full) or "249 zÄąâ€š" (short) |
| Dates | DD.MM.RRRR |
| Decimal separator | Comma ("22,0 momme") |
| Numbers always in digits | "22 momme" not "dwadzieÄąâ€şcia dwa" |
| Forbidden anglicisms | "premium look" Ă˘â€ â€™ "eleganckie wykoÄąâ€žczenie" |

### 6.5 Hardcoded text (by design)

> LUSENA targets the Polish market only. All sections use hardcoded Polish text directly in Liquid files rather than `{{ 'key' | t }}` translation filters. **This is intentional** Ă˘â‚¬â€ť there is no multi-language requirement. New sections should follow the same pattern: write Polish copy directly in the template.
...
- [ ] **Use Tailwind breakpoints** (`md:`, `lg:`, `xl:`) for responsive Ă˘â‚¬â€ť not Dawn's 750/990px.
- [ ] **Use semantic color classes** (`.text-primary`, `.bg-accent-cta`) Ă˘â‚¬â€ť not hardcoded hex in HTML.
- [ ] **Use `.lusena-btn--{variant}`** for all buttons Ă˘â‚¬â€ť never create ad-hoc button styles.
- [ ] **Use `{% render 'lusena-icon', name: 'Ă˘â‚¬Â¦' %}`** for all icons Ă˘â‚¬â€ť never paste raw SVG.
...
- [ ] **Keep touch targets Ă˘â€°Ä„ 44Ä‚â€”44px** on all interactive elements.
- [ ] **Use `data-lusena-*`** namespace for JS hooks Ă˘â‚¬â€ť never couple JS to CSS classes.
- [ ] **Write CSS in `{% stylesheet %}`** tag (inline) Ă˘â‚¬â€ť not in separate `.css` asset files.
- [ ] **Write JS in `{% javascript %}`** tag or via `<script>` + asset_url Ă˘â‚¬â€ť not inline `<script>` in HTML.
...
- [ ] **Use Tailwind breakpoints** (`md: 768px`, `lg: 1024px`) Ă˘â‚¬â€ť not Dawn's 750/990px Ă˘â‚¬â€ť for all responsive switches in new sections.
- [ ] **Hardcode Polish text** directly in templates Ă˘â‚¬â€ť no `{{ 'key' | t }}` needed (PL-only market).

### Don't

- [ ] Don't hardcode hex colors in HTML `style` attributes Ă˘â‚¬â€ť use CSS variables or Tailwind classes.
...
- [ ] Don't use Dawn's `.button` class Ă˘â‚¬â€ť use `.lusena-btn--{variant}` instead.
- [ ] Don't use `.page-width` Ă˘â‚¬â€ť use `.container` for LUSENA sections.
- [ ] Don't create icon fonts or reference icons by URL Ă˘â‚¬â€ť use the `lusena-icon` snippet.
- [ ] Don't add shadows beyond `shadow-sm` unless specifically needed Ă˘â‚¬â€ť the brandbook says "shadows sparingly."
- [ ] Don't use springy/bouncy/flashy animations Ă˘â‚¬â€ť keep motion calm (ease, ease-out, ease-in-out).
...
- [ ] Don't use `all-caps` for anything longer than 2Ă˘â‚¬â€ś3 words.
- [ ] Don't skip `aria-label` on icon-only buttons.
- [ ] Don't use color schemes 3 or 4 (dark backgrounds) in LUSENA sections Ă˘â‚¬â€ť no dark mode by brand decision.
- [ ] Don't use Dawn breakpoints (750/990px) in new LUSENA sections Ă˘â‚¬â€ť use Tailwind (768/1024px) unless syncing with Dawn layout classes.
...
```json
{
  "sections": {
    "contact_hero": {
      ...
      "settings": {
        "heading": "Skontaktuj siĂ„â„˘ z nami",
        "subheading": "Odpowiadamy w ciĂ„â€¦gu 24 godzin."
      }
    },
    "contact_form": {
...
- Online Store Ă˘â€ â€™ Pages Ă˘â€ â€™ Kontakt Ă˘â€ â€™ Template: `page.kontakt`

**Step 4:** Reuse existing sections when possible Ă˘â‚¬â€ť `lusena-trust-bar`, `lusena-faq` can be added to any page template.
...
{% schema %}
{
  ...
  "settings": [
    ...
    },
    {
      "type": "range",
      "id": "padding_top",
      "label": "Padding top override â€“ desktop",
      "min": 0,
      "max": 300,
      "step": 4,
      "unit": "px",
    ...
    },
    {
      "type": "range",
      "id": "padding_bottom",
      "label": "Padding bottom override â€“ desktop",
      "min": 0,
      "max": 300,
      "step": 4,
      "unit": "px",
    ...
    },
    {
      ...
      "label": "Padding top override â€“ mobile",
      "min": 0,
      "max": 300,
      "step": 4,
      "unit": "px",
    ...
    },
    {
      ...
      "label": "Padding bottom override â€“ mobile",
      "min": 0,
      "max": 300,
      "step": 4,
      "unit": "px",
...
2. Use a 24Ä‚â€”24 viewBox SVG, `fill="none"`, `stroke="currentColor"`, consistent stroke width (1.5px default).
...
- [ ] Image weight budgets: hero Ă˘â€°Â¤300KB, cards Ă˘â€°Â¤160KB, gallery Ă˘â€°Â¤220KB each.
- [ ] CSS is scoped via `{% stylesheet %}` (deferred loading, deduped by Shopify).
- [ ] No render-blocking JS Ă˘â‚¬â€ť use `{% javascript %}` tag or `defer`/`async` on script tags.
- [ ] No unused CSS/JS left in the page (check for leftover Dawn component files).
- [ ] Video embeds are deferred (click-to-play) Ă˘â‚¬â€ť never autoplay with sound.
...
- [ ] Touch targets Ă˘â€°Ä„ 44Ä‚â€”44px on mobile.
...
- [ ] `prefers-reduced-motion` respected Ă˘â‚¬â€ť all animations/transitions have reduced-motion fallbacks.
...
- [ ] Run `shopify theme check` Ă˘â‚¬â€ť ignore warnings listed in the known baseline (AGENTS.md).
...
| Newsletter | `sections/lusena-newsletter.liquid` | Homepage |
...
MOTION
  ...
  Hero entry   650Ă˘â‚¬â€ś900ms ease-out-slow
```

### 10.3 Brand vs. Implementation Gap Analysis

#### Matches (brand Ă˘â€ â€™ code alignment)

| Brandbook rule | Implementation status |
|---|---|
| Colors: porcelain bg, teal CTA, gold accent | Ă˘Ĺ›â€¦ Exact match |
| Fonts: Source Serif 4 + Inter | Ă˘Ĺ›â€¦ Exact match |
| CTA radius 6Ă˘â‚¬â€ś8px | Ă˘Ĺ›â€¦ Buttons 6px, pills 8px |
| CTA height 44Ă˘â‚¬â€ś48px | Ă˘Ĺ›â€¦ Default 48px, SM 44px |
| Focus: 2px outline | Ă˘Ĺ›â€¦ `box-shadow: 0 0 0 2px teal, 0 0 0 4px white` |
| Tap targets: min 44Ä‚â€”44px | Ă˘Ĺ›â€¦ All buttons/icon-buttons meet this |
| Max 2 CTAs per screen | Ă˘Ĺ›â€¦ Primary + secondary on PDP |
| Calm motion, no bounce | Ă˘Ĺ›â€¦ Ease/ease-out curves only |
| Reduced motion support | Ă˘Ĺ›â€¦ All CSS + JS respect it |
| Image ratios (4:5 PLP, 1:1 PDP) | Ă˘Ĺ›â€¦ Product card uses `aspect-[4/5]` |
| Icon style: outline, 1.5px stroke, 24px | Ă˘Ĺ›â€¦ Consistent in `lusena-icon.liquid` |
| "Imperfect Silk" photography | Ă˘ĹˇÂ ÄŹÂ¸Ĺą Not technically enforced Ă˘â‚¬â€ť content/art direction matter |

#### Mismatches / gaps

| Brandbook prescription | Current state | Risk |
|---|---|---|
| ~~i18n: `{{ 'key' | t }}` for all text~~ | All sections use hardcoded Polish strings | Ă˘Ĺ›â€¦ By design Ă˘â‚¬â€ť PL-only market, no multi-language planned |
| Neutral scale N0Ă˘â‚¬â€śN900 (10 steps) | Only N400, N700 used as utility classes | Low Ă˘â‚¬â€ť enough for current UI |
| Warning color `#B7791F` | Not used anywhere | Low Ă˘â‚¬â€ť no warning states in validated surfaces |
| Overlay/scrim tokens `--scrim-60`, `--scrim-80` | Hero uses `rgba(0 0 0 / X%)`, lightbox uses `rgba(0,0,0,0.92)` | Low Ă˘â‚¬â€ť works but doesn't use named tokens |
| Page margins: desktop 96px, tablet 64px, mobile 20Ă˘â‚¬â€ś24px | Container padding: 96px (xl), 64px (lg), 32px (md), 20px (mobile) | Ă˘Ĺ›â€¦ Close match |
| Column grid: 12/8/4 col with gutters | Sections use ad-hoc Tailwind grids, not formal 12-col | Low Ă˘â‚¬â€ť visual outcome is correct |
...
| Shipping progress bar visual | TealĂ˘â€ â€™green fill on 0.6rem track (white bg) |
...
| 2 | Collection page | **Already LUSENA-ized** | `templates/collection.json` maps to `lusena-main-collection.liquid` (breadcrumbs, product grid via `lusena-product-card`, pagination). Filter/sort button is non-functional Ă˘â‚¬â€ť to be removed/hidden (no sort/filter needed now). |
...
| 6 | Orphan snippets | **Backlog** | `lusena-pdp-accordions.liquid` Ă˘â‚¬â€ť verify and clean up later. |
...
- `lusena-pdp-styles.liquid` (2Ä‚â€”): Gallery show/hide and lightbox cursor must match Dawn's 750px media gallery flip.
- `lusena-comparison.liquid` (1Ä‚â€”): Table padding aligning with `.page-width`.
- `lusena-science.liquid` (1Ä‚â€”): 2-column layout matching Dawn layout.
...
| **`md`** | **`min-width: 768px`** | **Primary mobile Ă˘â€ â€™ desktop flip** (most common) |
...
Dawn's `base.css` uses 750/990 exclusively (25 and 15 occurrences respectively). This is fine Ă˘â‚¬â€ť LUSENA sections don't inherit Dawn's responsive grid classes; they use `.container` and Tailwind grids.

### 10.6 Font Loading (resolved Ă˘â‚¬â€ť self-hosted)

**Decision: Self-host both variable fonts from Shopify CDN. Google Fonts removed.**

Completed 2026-02-21. Fonts are now served from `assets/` via Shopify's CDN Ă˘â‚¬â€ť zero external requests, GDPR-clean.

#### Font files in `assets/`

| File | Font | Style | Weights | Size |
|---|---|---|---|---|
| `InterVariable.woff2` | Inter | Normal | 100Ă˘â‚¬â€ś900 | ~344 KB |
| `SourceSerif4Variable-Roman.woff2` | Source Serif 4 | Normal | 200Ă˘â‚¬â€ś900 | ~419 KB |
| `SourceSerif4Variable-Italic.woff2` | Source Serif 4 | Italic | 200Ă˘â‚¬â€ś900 | ~339 KB |

#### What was changed

**`layout/theme.liquid`:**
1. **Removed** the Google Fonts `<link>` block (preconnect + stylesheet, 9 lines).
2. **Added** 3 `@font-face` declarations inside the existing `{% style %}` block, using `{{ 'Ă˘â‚¬Â¦' | asset_url }}` for Shopify CDN delivery.
3. **Kept** the Shopify `font_face` filter lines Ă˘â‚¬â€ť they still generate `@font-face` for Inter 400/700 and Source Serif 4 400 from `fonts.shopifycdn.com`. The self-hosted variable fonts take priority via CSS cascade (they appear later and cover a wider weight range).
...
```
This covers Latin, Latin Extended-A (Polish characters: Ă„â€¦, Ă„â€ˇ, Ă„â„˘, Äąâ€š, Äąâ€ž, Ä‚Ĺ‚, Äąâ€ş, ÄąĹź, ÄąÄ˝), Latin Extended-B, and common symbols/currency.

#### Weight coverage (before vs. after)

| Weight | Before (Google) | After (self-hosted) | Used in theme? |
|---|---|---|---|
| Inter 300 | Ă˘Ĺ›â€¦ | Ă˘Ĺ›â€¦ | Yes Ă˘â‚¬â€ť `font-light` |
| Inter 400 | Ă˘Ĺ›â€¦ | Ă˘Ĺ›â€¦ | Yes Ă˘â‚¬â€ť default body |
| Inter 500 | Ă˘Ĺ›â€¦ | Ă˘Ĺ›â€¦ | Yes Ă˘â‚¬â€ť `font-medium` (most used) |
| Inter 600 | Ă˘Ĺ›â€¦ | Ă˘Ĺ›â€¦ | Yes Ă˘â‚¬â€ť `font-semibold` |
| Inter 700 | Ă˘Ĺ›â€¦ | Ă˘Ĺ›â€¦ | Yes Ă˘â‚¬â€ť bold |
| Source Serif 4 (all weights) | Ă˘Ĺ›â€¦ | Ă˘Ĺ›â€¦ | Yes Ă˘â‚¬â€ť headings, logo |
| Source Serif 4 italic | Ă˘Ĺ›â€¦ | Ă˘Ĺ›â€¦ | Yes Ă˘â‚¬â€ť hero, PDP eyebrow |
...
- Ă˘Ĺ›â€¦ All Inter weights (300/400/500/600/700) render correctly with visible weight differentiation
- Ă˘Ĺ›â€¦ Source Serif 4 normal + italic render at all weights
- Ă˘Ĺ›â€¦ Polish characters (Ă„â€¦Ă„â€ˇĂ„â„˘Äąâ€šÄąâ€žÄ‚Ĺ‚Äąâ€şÄąĹźÄąÄ˝) display correctly
- Ă˘Ĺ›â€¦ `document.fonts` API confirms all font faces loaded from Shopify CDN
- Ă˘Ĺ›â€¦ Zero requests to `fonts.googleapis.com` or `fonts.gstatic.com`
- Ă˘Ĺ›â€¦ Debug section removed after successful verification
