...
> Each item references brandbook v2 (`docs/LUSENA_BrandBook_v2.md`) requirements.
...
- **Ref:** `docs/LUSENA_BrandBook_v2.md:1412`, `docs/LUSENA_BrandBook_v2.md:1725`, `docs/LUSENA_BrandBook_v2.md:2018`.
...
- **Ref:** `docs/LUSENA_BrandBook_v2.md:1407`, `docs/LUSENA_BrandBook_v2.md:1562`.
...
- **Ref:** `docs/LUSENA_BrandBook_v2.md:2035`.
