...
- [x] Cart page CSS extraction (`assets/lusena-cart-page.css`) — 624 lines extracted from cart-items, cart-footer, and cart-quantity `{% stylesheet %}` blocks. Resolved compiled_assets truncation (85KB → ~59KB). (2026-03-26, loading dots CSS removed 2026-03-29)
