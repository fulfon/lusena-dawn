...
> Each item references the brandbook v2 (`memory-bank/doc/brand/LUSENA_BrandBook_v2.md`) specification.
...
- **Ref:** `memory-bank/doc/brand/LUSENA_BrandBook_v2.md:1245` (homepage item 4, "kotwica wartości").
...
- **Ref:** `memory-bank/doc/brand/LUSENA_BrandBook_v2.md:97` (tier hierarchy), `memory-bank/doc/brand/LUSENA_BrandBook_v2.md:1245` (homepage item 4).
...
- **Ref:** `memory-bank/doc/brand/LUSENA_BrandBook_v2.md:1245` (homepage item 6, "Grid 3-4 zdjęć UGC / screenów opinii").
...
- **Ref:** `memory-bank/doc/brand/LUSENA_BrandBook_v2.md:1245` (homepage item 1, "Opcjonalnie").
...
- Cross-reference `memory-bank/doc/brand/LUSENA_BrandBook_v2.md` for exact copy and specifications.
