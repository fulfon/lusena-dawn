...
| Vendor | LUSENA | Done |
| Tags | jedwab, poszewka, 22-momme, nocna-rutyna, flagship | Done |
...
| Field | Value | Status |
|-------|-------|--------|
| Inventory tracked | Yes | Done |
| Quantity (all locations) | 0 | Done (update when stock arrives) |
| Continue selling when OOS | No | Done |
...
| Metafield | Value | Status |
|-----------|-------|--------|
| `lusena.pdp_specs_material` | 100% jedwab morwowy (Mulberry Silk) | Done |
| `lusena.pdp_specs_weave` | Charmeuse (splot satynowy) | Done |
| `lusena.pdp_specs_momme` | 22 momme | Done |
...
| Metafield | Value | Status |
|-----------|-------|--------|
| `lusena.pdp_packaging_items` | ["Jedwabna poszewka LUSENA", "Eleganckie pudełko prezentowe LUSENA", "Karta z instrukcją pielęgnacji"] | Done |
